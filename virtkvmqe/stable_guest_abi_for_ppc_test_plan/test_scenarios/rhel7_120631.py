...
def run_case(params):
    ...
    test = CreateTest(case_id='rhel7_120631', params=params)
    id = test.get_id()
    ...
    if (flag == 'p9_to_p8'):
        params.vm_base_cmd_update('machine', 'pseries',
                                  'pseries-rhel7.2.0,max-cpu-compat=power8')
    else:
        params.vm_base_cmd_update('machine', 'pseries', 'pseries-rhel7.2.0')
    ...
    if (flag == 'p8_to_p9'):
        params.vm_base_cmd_update('machine', 'pseries-rhel7.2.0',
                                  'pseries-rhel7.2.0,max-cpu-compat=power8')
    elif (flag == 'p9_to_p8'):
