...
def run_case(params):
    ...
    src_host_session.host_cmd_output('qemu-img create -f qcow2 %s/data-disk0.qcow2 2G' %share_images_dir)
    src_host_session.host_cmd_output('qemu-img create -f qcow2 %s/data-disk1.qcow2 2G' %share_images_dir)
