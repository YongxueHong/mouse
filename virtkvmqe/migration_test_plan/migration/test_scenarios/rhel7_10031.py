...
def run_case(params):
    ...
    output = src_host_session.host_cmd_output('qemu-img create -f qcow2 %sdata-disk0.qcow2 10G' %share_images_dir)
    ...
    params.vm_base_cmd_add('drive', 'id=drive_data0,if=none,cache=none,format=qcow2,snapshot=on,file=%s/data-disk0.qcow2' %share_images_dir)
