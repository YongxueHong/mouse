...
def run_case(params):
    ...
    test.sub_step_log('4.Check guest on des, guest should work well')
    ...
    test.sub_step_log('4.1Can access guest from external host')
    ...
    test.sub_step_log('5.Reboot guest, guest should work well.')
